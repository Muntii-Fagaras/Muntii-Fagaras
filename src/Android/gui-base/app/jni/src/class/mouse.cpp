...
inline bool mouse::is_cursor_in_box_with_click(int xl, int yu, int xr, int yd) {
	// マウスの現在位置を取得する
...
inline void mouse::update_cursor(std::string mouse_cursor)
{
...
inline bool mouse::clicked_left_down(SDL_Event left_clicked_event) {
...
inline bool mouse::clicked_left_up(SDL_Event left_clicked_event) {
	if (left_clicked_event.button.button == SDL_BUTTON_LEFT
